...
Label(root,text="2021-MC-17 ",font=("Calibri",20),bg="#0000FF",fg="#fffdd0").place(relx=0.75,rely=0.2)
Label(root,text="Hammad Sajjad",font=("Calibri",20),bg="#0000FF",fg="#fffdd0").place(relx=0.75,rely=0.25)
...
# Releasing the video capture and closing the windows when the program ends